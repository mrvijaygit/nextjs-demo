...
export default function IosInfo() {
    ...
    if (validateInput(inputValue)) {
        ...
        if (dataString) {
          try {
            ...
            data.windows_app_bundle_id = inputValue;
  ...
  const nextPageHandler = (): string => {
    ...
    const platforms = supportPlatforms.filter((platform: string) => (platform !== 'Android' && platform !== 'iOS' && platform !== 'macOS' && platform !== 'Windows'));
